...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/CJHF");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_CJHF ?? "horsefiretablet.com/cjhf");

            // let tracker = searchParams.get("krt-tracker");
            const searchParamss_krt = searchParams.get("krt");
            const searchParamss_krttracker = searchParams.get("krttracker");

            // this is for onclick new plateform
            const searchParamss_onclicka = searchParams.get("hftonclika");
            ...
            searchParamss_onclicka && formdata.append("conversions_onclicka", searchParamss_onclicka);
        ...
        <section>
            ...
            <div className="mt-4 pb-5 bg-white" id="form">
                ...
                <div className={`pb-4 text-black  ${poppin.className}`} id='formcallhide'>
                    <div className="max-w-2xl mx-4 md:mx-auto rounded-lg  bg-[#2ab9cc] p-3 border border-[#d6c1a5] ">
                        <div className="py-4">
