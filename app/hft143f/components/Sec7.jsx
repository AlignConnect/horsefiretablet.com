...
const Sec7 = () => {
  ...
  return (
    <div className="bg-black ">
      <div className='relative py-5 sm:py-10 px-3 sm:px-5 text-center'>
        ...
        <div className="grid grid-cols-2 mt-5 sm:grid-cols-4 text-xl text-white items-center justify-center gap-3">
          {list.map((e,key) => {
