...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/HFS")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFS ?? "horsefiretablet.com/hfs")
            ...
            <div className="px-3">
                ...
                <div className="" id='form'>
                    <div className=" " id='formcallhide'>
                        <div className="mx-auto font-poppin formback px-4 pb-6 border rounded-lg ">
                            <div>
                                ...
                                <form className="space-y-3">
                                    ...
                                    <div className="flex justify-center items-center pt-4 ">
                                        <button onClick={handleFormSubmit} type="button" className="bg-gradient-to-b from-[#ffd900] via-[#ffbe00] to-[#fe8d00] text-xl font-bold p-3 pt-3 md:w-72 w-full rounded-full">
                                            SUBMIT
                                        </button>
                                    </div>
                                </form>
