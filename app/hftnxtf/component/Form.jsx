...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/HFTNXTF");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFTNXTF ?? "horsefiretablet.com/hftnxtf");
            ...
            try {
                const form = await fetch(`https://  .com/submitdata.php`, { body: formdata, method: "POST" })
