...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/HFD")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFD ?? "horsefiretablet.com/hfd")
    ...
    return (
        <div id="form" className={noto.className}>
            ...
            >
                <div className="max-w-7xl mx-auto py-6 md:py-12 px-3">

                    <h1 className="text-3xl md:text-[3.6rem] text-[#feffa6] text-center font-bold mb-2 md:mb-6">कॉल पर विशेषज्ञ डॉक्टरों से मुफ्त सलाह के लिए फॉर्म भरें !</h1>
                    <div className="grid grid-cols-12 m-0 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <form className="space-y-3">
                                            ...
                                            <div className="flex justify-center items-center pt-4 ">
                                                <button onClick={handleFormSubmit} type="button" className="bg-[#293a6e] text-xl font-bold p-3 pt-3 md:w-72 w-full rounded-full hover:bg-[#293a6e]/80 transition-colors text-white">
                                                    SUBMIT
                                                </button>
                                            </div>
                                        </form>
                        ...
                        <div className="col-span-12 md:col-span-6 text-white font-nunito mt-6 md:mt-0">
                            <h1 className=" font-bold text-3xl md:text-5xl leading-normal">Helping Patients From all Over The India</h1>
                            <div className="md:text-3xl text-xl font-bold md:mt-12 mt-6 text-[#0e204e] bg-white px-3 py-2 rounded-full inline-block">
                                <MdOutlineSupportAgent className="inline text-5xl  " /> We Are Available Now
                            </div>
                            <hr className="border-t-2 my-6 md:my-12  opacity-100" />

                            <h1 className="text-2xl font-noto font-semibold md:text-4xl">नोट- अन्य ग्राहकों के लिए 50% का बम्पर डिस्काउंट और ऑनलाइन पेमेंट पर 10% अतिरिक्त बचत उपलब्ध है।</h1>
                        </div>
                    </div>
                </div>
            </div>
