...
import reviewsData from '../../eng_review.json'
            ...
            .slice(0, numberOfitemsShown).map((e, key) => {
                ...
                return <div className='' key={key}>
                    <div className=" mx-2 my-5 p-2 rounded-md" style={{ boxShadow: " rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(90, 125, 188, 0.05) 0px 0.25em 1em" }} key={key}>
                        ...
                        <div className='fontNoto text-start mt-0 text-[1rem] py-1 '>{e.comment}</div>
                        ...
                        <div className="px-2 pt-4 w-full">
                            ...
                            <div className="grid grid-cols-12 items-center justify-center py-5 px-2">
                                <img
                                    ...
                                    className="sm:w-3/4 w-full mx-auto col-span-4 sm:col-span-6"
                                />

                                <div className="col-span-8 sm:col-span-6">


                                    <div className="fontJosefin sm:text-3xl text-[1.1rem] px-3 font-bold leading-tight">
                                        TOP<br />
                                        RATED
                                    </div>
                                    ...
                                    <div className="flex items-center sm:pl-3 pl-2 sm:py-3 py-1">
                                        {iconsArray.map((_, index) => (
                                            <MdOutlineStarPurple500 key={index} className="text-yellow-500 text-lg sm:text-3xl" />
                                        ))}
                                        <span className="text-gray-700 sm:text-lg text-md pl-2">| 4.3 out of 5</span>
                                    </div>

                                    <div className="fontJosefin  bg-red-600 sm:text-xl text-sm text-center sm:pt-2 pt-1  w-[90%] mx-auto sm:mx-0 text-white font-bold sm:rounded-xl">
                                        LOVED BY CUSTOMER'S
                                    </div>
