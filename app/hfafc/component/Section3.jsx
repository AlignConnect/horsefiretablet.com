...
const Section3 = () => {
    return (
        <div className='w-[70%] mx-auto'>
            ...
            <div>
                <p className='fontNoto text-4xl my-14 font-bold leading-relaxed text-center pt-5'>
            ...
            <div className='bg-[#fff116] rounded-xl pb-5'>
                <div className='grid grid-cols-4 items-center mx-auto text-center fontAnton text-xl'>
                    ...
                    <div>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/55f56acb-0929-480b-4521-8755968e8e00/public" alt="sdsds" loading='lazy' className='mx-auto py-5' />
                        </div>

                        <div>
                            <p>Big Discount <br /> in Festival Season</p>
                        </div>
                    </div>
