...
const Section2 = () => {
    return (
        <div>
            ...
            <div className='fontNoto w-[75%] mx-auto'>
                <div className='text-5xl  mx-auto font-bold   py-10 leading-tight text-center'>
                    <p>अब आपके मन में सवाल आ रहा होगा की आखिर उनके बड़े लिंग </p>
                    <p> और ज्यादा सेक्स पॉवर के पीछे कौन सी जड़ीबूटियां है।</p>
                </div>

                <h1 className='text-2xl w-[80%] mx-auto text-center'>Withania Somnifera, Asphaltum, Chlorophytum Borivilianum, Crocus sativus, Tribulus Terrestris ये कुछ खास अफ्रीकन हर्ब्स है जिन्हे भारत में अश्वगंधा, शिलाजीत, सफ़ेद मूसली, केसर, गोक्षुरा के नाम से जाना जाता है। फर्क बस इतना है की वहा के लोग इन हर्ब्स के फायदे को जानते है पर भारतीय पुरुष इतने पावरफुल जड़ीबूटियों के फायदे से अनजान है। </h1>
                ...
                <div className='grid grid-cols-3 gap-16 my-24'>
                    ...
                    <div className='flex items-center gap-4'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/53459e1e-8bb4-45e8-57b5-6005113bc600/public" alt="sdsd" loading='lazy' className='min-w-[120px] min-h-[120px] rounded-full' />
                        </div>

                        <div>
                            <h1 className='text-4xl font-bold'>अश्वगंधा</h1>
                    ...
                    <div className='flex items-center gap-4'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/655e2b51-bdb5-4d17-8883-b9e284613000/public" alt="sdsd" loading='lazy' className='min-w-[120px] min-h-[120px] rounded-full' />
                        </div>

                        <div>
                            <h1 className='text-4xl font-bold'>शिलाजीत</h1>
                            <p className='text-[19px] font-[500]'>
                    ...
                    <div className='flex items-center gap-4'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/4493267f-8502-483a-7216-50a2f6179500/public" alt="sdsd" loading='lazy' className='min-w-[120px] min-h-[120px] rounded-full' />
                        </div>

                        <div>
                            <h1 className='text-4xl font-bold'>सफेद मूसली</h1>
                            <p className='text-[19px] font-[500]'>
                    ...
                    <div className='flex items-center gap-4'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/56d8d4cf-fb0c-47d2-ee04-bb9aae126100/public" alt="sdsd" loading='lazy' className='min-w-[120px] min-h-[120px] rounded-full' />
                        </div>

                        <div>
                            <h1 className='text-4xl font-bold'>गोक्षुरा</h1>
                            <p className='text-[19px] font-[500]'>
                    ...
                    <div className='flex items-center gap-4'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/47d17563-1fa0-44b2-1b4b-5b610037f800/public" alt="sdsd" loading='lazy' className='min-w-[120px] min-h-[120px] rounded-full' />
                        </div>

                        <div>
                            <h1 className='text-4xl font-bold'>केसर</h1>
                            <p className='text-[19px] font-[500]'>
                    ...
                    <div className='flex items-center gap-2'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/6b549606-0140-4d61-568d-72b5afc06300/public" alt="sdsd" loading='lazy' className='min-w-[120px] min-h-[120px] rounded-full' />
                        </div>

                        <div>
                            <h1 className='text-4xl font-bold'>शतावरी</h1>
                            <p className='text-[19px] font-[500]'>
                ...
                <div className='my-10'>
                    <h1 className='text-3xl leading-10 fontNoto text-center font-bold'>17 शक्तिशाली जड़ीबूटियों और भस्मों से बना Horse Fire Tablet भारत का सबसे ज्यादा बिकने वाला सेक्सवर्धक है। यह नैचुरल तरीके से खोई हुई मर्दाना शक्ति को रिस्टोर करने का काम करता है।</h1>
                </div>
                ...
                <div className='w-[100%] mx-auto'>
                    ...
                    <div className='grid grid-cols-2 items-center py-5'>
                        ...
                        <div className='rounded-xl overflow-hidden'>
                            ...
                            <div className='bg-[#fff116] flex items-center justify-center gap-5'>
                                <p className='font-bold text-xl py-5'>WE HAVE SOLUTION FOR YOUR PROBLEMS</p>
                                <button className='rounded-full bg-black py-2 px-10 text-2xl text-white fontAnton'>BUY NOW</button>
                            </div>
                        </div>


                        <div className='w-[80%] mx-auto fontNoto text-white text-4xl'>
                            ...
                            <div className='text-start'>
                                ...
                                <div className='mt-16 mb-5 flex gap-4 items-center '>
                                    <div>
