    ...
    <div className="">
      ...
      <div className='my-5 sm:my-10'>
        <div className="max-w-96 px-3 mx-auto">
          ...
          <div className="border-4 border-red-700 p-5 sm:p-8 rounded-b-[3rem]">
            <img src={'https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/6cb83816-5cb9-454a-bc9e-df8fb9e78900/public'} alt="pic" height='100%' width='100%' loading='lazy' />
            <OrderBtn />
          </div>
        </div>
      ...
      <div className="bg-black text-white p-5">
        <div className=" p-5 sm:py-10 border border-dotted border-[yellow]">
          ...
          <p className=" text-center font-bold text-xl sm:text-[1.6rem] leading-snug">
