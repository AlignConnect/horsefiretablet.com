        ...
        <section>
            ...
            {/* <div className="">
                <div className="bg-red-600  text-white py-5 flex items-center justify-between">
                    ...
                    <div className="w-full max-w-6xl mx-auto grid sm:grid-cols-2 justify-center items-center">
            ...
            <div className='max-w-2xl mx-auto'>
                ...
                <div className="p-3 w-full mx-auto text-center">
                    <div className="purchaseProduct leading-tight text-center py-2 mb-0">HORSE FIRE TABLET खरीदने के लिए निचे क्लिक करें</div>
