    ...
    const itemsToShow = useMemo(() => {
        return Reviews
            .slice(0, numberOfitemsShown).map((e, key) => {
                ...
                return <div key={key}>
                    <div className="mx-2 bg-white my-5 p-2 rounded-md" style={{ boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }} key={key}>
                        <div className='flex justify-start align-items-center gap-2 mb-2 mt-2'>
                            ...
                            <div>
                                <h5 className='mb-0 text-center align-center text-xl fontPoppins font-semibold'>{e.name}&nbsp;
                                    <img
                                        decoding='async'
