...
const FlipAmazon = () => {
    return (
        ...
        <div>
            {/* <div className="py-3 w-100 px-1 text-center">
                <a href="https://bit.ly/3w4Z8Ds" className=" w-full d-grid leading-none">
                    <h5 className="purchaseProduct leading-tight  py-2 mb-0 text-md">HORSE FIRE TABLET खरीदने के लिए निचे क्लिक करें</h5>
                    <img
            ...
            <div className="p-3 bg-white w-full mx-auto text-center">
