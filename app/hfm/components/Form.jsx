...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/HFM");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFM ?? "horsefiretablet.com/hfm");
        ...
        <section>
            ...
            <div className="mt-4 pb-5 bg-white" id="form">
                ...
                <div className={`pb-4 text-black ${poppin.className}`} id='formcallhide'>
                    <div className="max-w-2xl mx-4 md:mx-auto rounded-lg  bg-slate-50 p-3 border border-[#d6c1a5] ">
                        <div className="py-4">
