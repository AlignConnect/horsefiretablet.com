...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/HXB");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HXB ?? "horsefiretablet.com/hxb");
        ...
        <section className='w-full max-w-2xl mx-auto'>
            ...
            <div className="bg-[#e5eae4] pb-10 md:px-2" id="form">
                ...
                <div className="text-center py-5">
                    <h1 className="text-[1.5rem] md:text-3xl font-bold fontSumana text-black">कॉल पर विशेषज्ञ डॉक्टरों से<br /> मुफ्त सलाह के लिए फॉर्म भरें!</h1>
                </div>
                    ...
                    <div className="bg-white max-w-2xl mx-2 md:mx-12 md:px-4 px-1 rounded-md" style={{ boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }}>
                        <div className="py-5">
                            <div className="text-center">
                                <h1 className=" text-3xl md:text-4xl font-bold mb-5 inline-block fontSumana"> Contact Us </h1>
                            </div>
                            <form className="space-y-3 px-2">

                                {CustomerDataValue?.map((data, key) => {
                                    return <div className="flex flex-col" key={key}>
                                        <label className="font-semibold font text-left text-[0.9rem] py-1">{data.label}</label>
                                ...
                                <div className="flex justify-center items-center pt-6 ">
                                    <button onClick={handleFormSubmit} type="button" className="fontSumana text-2xl font-bold p-3 pt-2 md:w-72 w-full rounded-md bg-black text-white">
                                        SUBMIT
                                    </button>
                                </div>
                            </form>
