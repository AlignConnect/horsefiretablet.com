...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/HFTENGF")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFTENGF ?? "horsefiretablet.com/hftengf")
    ...
    return (
        <div id="form" className={noto.className}>
            ...
            <div className="doctor_header_background">
                <div className=""
                >
                    <div className="max-w-6xl mx-auto py-9 md:py-24 px-2">

                        <h1 className="fontPoppins uppercase text-[1.3rem] md:text-3xl text-black text-center fw-bold mb-6 md:mb-12 font-extrabold">Fill out the form to free expert's consultation on call!</h1>
                        <div className="grid grid-cols-12 m-0 gap-6 items-center">
                            <div className="col-span-12 md:col-span-6 fontPoppins text-black font-nunito mt-1 md:mt-0 order-2 sm:order-1">
                                <h1 className="text-sm fontPoppins text-justify font-bold md:text-xl">So what are you waiting for, take the first step towards a happy sexual life and get free advice from experts!!</h1>

                                <hr className="border-t-2 my-3 md:my-6  opacity-100" />

                                <h1 className=" font-bold text-xl md:text-2xl leading-normal">Helping Patients From all Over India</h1>
