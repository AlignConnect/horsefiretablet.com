...
const BottomHandler = () => {
    ...
    function checkcall() {
        ...
        switch (checkcolumn) {
            ...
            case "/hftsrh":
                return setAp({
                    api: process.env.NEXT_APP_URL_HFTSRH,
                    key: process.env.NEXT_APP_API_KEY_HFTSRH
                });


            case "/hftsrhf":
                return setAp({
                    api: process.env.NEXT_APP_URL_HFTSRHF,
                    key: process.env.NEXT_APP_API_KEY_HFTSRHF
                });
            ...
            case "/hfengf":
                return setAp({
                    api: process.env.NEXT_APP_URL_HFENGF,
                    key: process.env.NEXT_APP_API_KEY_HFENGF
                });

            case "/hftgf":
                return setAp({
                    api: process.env.NEXT_APP_URL_HFTGF,
