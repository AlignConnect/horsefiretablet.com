...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/HFTRCIF");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFTRCIF ?? "horsefiretablet.com/hftrcif");
    ...
    return (
        <>
            ...
            <section className='bg-white '>
                ...
                <div className="relative z-20 pt-5 pb-10 sm:py-10 px-3 md:px-10" id="form">
