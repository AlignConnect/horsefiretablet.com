          ...
          <div className="sm:col-span-5 text-center sm:text-left">
            ...
            <div className="flex sm:w-full justify-center my-5 items-center sm:justify-start gap-3 sm:gap-5">
              ...
              <a href={links?.flipkartMain}
                className=""><img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/1369a0a5-d191-4392-bf47-5c170ecb8600/public" alt="pic" className="w-36 sm:w-40" width='100%' height='100%' /></a>


              <a href={links?.amazonMain}

                className=""><img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/3edacd08-1afb-49b1-9aba-2cdda7681400/public" alt="pic" className="w-36 sm:w-40" width='100%' height='100%' /></a>
