...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/HFTVHTF");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFTVHTF ?? "horsefiretablet.com/hftvhtf");
    ...
    return (<div className="pb-5" id="form">
        ...
        <div className={` text-black text-start fontPoppins`} id='formcallhide'>
            <div className=" md:mx-auto  bg-slate-50 p-3 border border-[#d6c1a5] rounded-2xl">
                <div className="py-4">
