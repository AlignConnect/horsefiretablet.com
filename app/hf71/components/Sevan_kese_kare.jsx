        ...
        <div className='w-full relative'>
            <div className='relative z-10 py-5 sm:py-10 px-5 sm:px-7 '>
                ...
                <div className="grid sm:grid-cols-12 items-end">
                    ...
                    <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/a1342a54-74cf-48a7-46b6-8e3b4f84b500/public' alt="pic" width='100%' height='100%' loading='lazy' className='mt-5 sm:mt-0' />
                    </div>
                </div>

            </div>
            <Image src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/bd2898e0-7cc4-4140-c4d0-6f199196ba00/public' fill loading='lazy'  alt='pic' />
        </div>
