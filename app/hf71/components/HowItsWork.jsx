    ...
    return (
        <div className="">
            ...
            <div className='w-full relative bg-[#272526]'>
                <div className=" py-5 text-center px-3 sm:px-5 text-white">
                    ...
                    <div className="grid sm:grid-cols-2 ">
                        <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/da0defa9-9b75-49c9-ee28-3f0b21487200/public' alt="pic" width='100%' height='100%' loading="lazy" className="hidden sm:block" />
                        <div className="sm:text-end text-2xl sm:text-3xl">
                            ...
                            <img src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/da0defa9-9b75-49c9-ee28-3f0b21487200/public' alt="pic" width='100%' height='100%' loading="lazy" className=" sm:hidden mt-5" />
            ...
            <div className=' relative'>
                ...
                <Image src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/3d64ed38-5e4b-4979-99d7-7cec397c6d00/public' fill loading="lazy"  alt='pic' />
            </div>
        </div>
    )
}
