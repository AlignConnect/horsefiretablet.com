...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefiretablet.com/HF369CLICKADU");
            formdata.append("ip", check ? check : "");
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
            formdata.append("blog_url", process.env.NEXT_APP_URL_HF369CLICKADU?? "horsefiretablet.com/hf369clickadu");
    ...
    return (
        ...
        <section>
            ...
            <div className="mt-4" id="form">
                ...
                <div className={`pb-2 text-black ${poppin.className}`} id='formcallhide'>
                    <div className="max-w-2xl mx-4 md:mx-auto rounded-[30px] bg-slate-50 p-3 border border-[#d6c1a5] trx">
                        <div className="py-4">
                            ...
                            <form className="space-y-3">
                                ...
                                <div className="flex justify-center items-center pt-4 ">
                                    <button onClick={handleFormSubmit} type="button" className="bg-zinc-900 text-xl font-bold p-3 pt-3 w-[200px] rounded-[10px] hover:bg-zinc-950 transition-colors text-white">
                                        SUBMIT
                                    </button>
                                </div>
                            </form>
