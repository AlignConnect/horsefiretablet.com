...
const CustomerReview = () => {
                ...
                return <div key={key}>
                    <div className="mx-2 my-5 p-2 rounded-md" style={{ boxShadow: "-1px 0px 5px 0px black" }} key={key}>
                        <div className='flex justify-start align-items-center gap-2 mb-2 mt-2'>
                            ...
                            <div>
                                <h5 className='mb-0 text-center align-center text-xl font-bold'>{e.name}&nbsp;<img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d6864046-cca9-417f-d247-ad0766062c00/public" className='w-[18px] h-[18px] inline' alt="pic" loading='lazy' /></h5>
                        ...
                        <div className="w-full md:w-[20rem] m-auto">
                            {/* {
                                ...
                                key === 0 &&
                                <img src="/reviews/new12.jpg" alt="no" className='max-w-[300px] md:max-w-[20rem] mx-auto' loading='lazy' />
                            } */}
                            {

                                key === 1 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/b15dfcf0-712c-4ad1-749a-38d3b6682d00/public" alt="no" className='max-w-[300px] md:max-w-[20rem] mx-auto' loading='lazy' />
                            }
                            {

                                key === 2 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/ce3611bd-2dc5-4d37-f080-47c4eb429700/public" alt="no" className='max-w-[300px] md:max-w-[20rem] mx-auto' loading='lazy' />
                            }

                            {
                                key === 5 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/a151ce1b-6321-4327-01c6-f6e72a537e00/public" alt="no" className='max-w-[300px] md:max-w-[20rem] mx-auto' loading='lazy' />
                            }

                            {
                                key === 10 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d28d6f15-4b96-4a08-e22a-84832551ad00/public" alt="no" className='max-w-[300px] md:max-w-[20rem] mx-auto' loading='lazy' />
                            }
    ...
    return (
        ...
        <section className={`${noto.className} w-full bg-white py-3 md:py-7 bg-gray-700`}>
